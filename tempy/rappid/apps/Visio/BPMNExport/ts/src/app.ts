...
import { VisioArchive, VisioShape, types, util as vsdUtil } from '@clientio/rappid-visio';
...
export const init = async() => {
    ...
    async function exportPaperToVSDX(paper: dia.Paper) {
    ...
    function addDemoCells(graph: dia.Graph) {
