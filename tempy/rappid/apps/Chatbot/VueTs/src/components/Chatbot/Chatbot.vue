<template>
    <div class="rappid-scope chatbot">
        <div ref="toolbar"></div>
        <div class="side-bar">
...
import JsonEditor from 'src/components/Chatbot/Json-editor/Json-editor.vue';
import Inspector from 'src/components/Chatbot/Inspector/Inspector.vue';
