...
<script lang="ts">
    ...
    import MessageInspector from 'src/components/Chatbot/Inspector/Message-inspector/Message-inspector.vue';
    import LabelInspector from 'src/components/Chatbot/Inspector/Label-inspector/Label-inspector.vue';
    import LinkInspector from 'src/components/Chatbot/Inspector/Link-inspector/Link-inspector.vue';
