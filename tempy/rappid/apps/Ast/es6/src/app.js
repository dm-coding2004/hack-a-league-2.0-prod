import { dia, ui, graphUtils, layout } from '@clientio/rappid';
...
export const init = () => {
    ...
    exportSvgBtn.addEventListener('click', () => paper.openAsSVG({ useComputedStyles: false }));
    exportPngBtn.addEventListener('click', () => paper.openAsPNG({ useComputedStyles: false }));
