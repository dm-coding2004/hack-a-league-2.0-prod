...
app.AppView = joint.mvc.View.extend({
    ...
    loadExample: function() {
        ...
        this.selection.reset([]);
        this.graph.fromJSON({ 'cells':[{ 'type':'qad.Question','optionHeight':30,'questionHeight':45,'paddingBottom':30,'minWidth':150,'ports':{ 'groups':{ 'in':{ 'position':'top','attrs':{ 'circle':{ 'magnet':'passive','stroke':'white','fill':'#feb663','r':14 },'text':{ 'pointerEvents':'none','fontSize':12,'fill':'white' }},'label':{ 'position':{ 'name':'left','args':{ 'x':5 }}}},'out':{ 'position':'right','attrs':{ 'circle':{ 'magnet':true,'stroke':'none','fill':'#31d0c6','r':14 }}}},'items':[{ 'group':'in','attrs':{ 'text':{ 'text':'in' }},'id':'0827c5d5-e3e4-47db-b2a7-665e47e5ffbc' },{ 'group':'out','id':'yes','args':{ 'y':60 }},{ 'group':'out','id':'no','args':{ 'y':90 }}] },'position':{ 'x':45,'y':38 },'size':{ 'width':150.3125,'height':135 },'angle':0,'question':'Does the thing work?','inPorts':[{ 'id':'in','label':'In' }],'options':[{ 'id':'yes','text':'Yes' },{ 'id':'no','text':'No' }],'id':'41dd3458-88ec-4c64-a90c-1e2852dd2af5','z':1,'attrs':{ '.question-text':{ 'text':'Does the thing work?' },'.options':{ 'transform':'translate(0, 45)' },'.option-yes':{ 'transform':'translate(0, 0)','dynamic':true },'.option-yes .option-rect':{ 'height':30,'dynamic':true },'.option-yes .option-text':{ 'text':'Yes','dynamic':true,'refY':15 },'.option-no':{ 'transform':'translate(0, 30)','dynamic':true },'.option-no .option-rect':{ 'height':30,'dynamic':true },'.option-no .option-text':{ 'text':'No','dynamic':true,'refY':15 }}},{ 'type':'qad.Question','optionHeight':30,'questionHeight':45,'paddingBottom':30,'minWidth':150,'ports':{ 'groups':{ 'in':{ 'position':'top','attrs':{ 'circle':{ 'magnet':'passive','stroke':'white','fill':'#feb663','r':14 },'text':{ 'pointerEvents':'none','fontSize':12,'fill':'white' }},'label':{ 'position':{ 'name':'left','args':{ 'x':5 }}}},'out':{ 'position':'right','attrs':{ 'circle':{ 'magnet':true,'stroke':'none','fill':'#31d0c6','r':14 }}}},'items':[{ 'group':'in','attrs':{ 'text':{ 'text':'in' }},'id':'3da4004a-938e-4b8d-aac7-94f93eded50a' },{ 'group':'out','id':'yes','args':{ 'y':60 }},{ 'group':'out','id':'no','args':{ 'y':90 }}] },'position':{ 'x':55,'y':245 },'size':{ 'width':195.65625,'height':135 },'angle':0,'question':'Did you mess about with it?','inPorts':[{ 'id':'in','label':'In' }],'options':[{ 'id':'yes','text':'Yes' },{ 'id':'no','text':'No' }],'id':'22a1f5ae-c415-4927-bccc-403699971d88','z':2,'attrs':{ '.question-text':{ 'text':'Did you mess about with it?' },'.options':{ 'transform':'translate(0, 45)' },'.option-yes':{ 'transform':'translate(0, 0)','dynamic':true },'.option-yes .option-rect':{ 'height':30,'dynamic':true },'.option-yes .option-text':{ 'text':'Yes','dynamic':true,'refY':15 },'.option-no':{ 'transform':'translate(0, 30)','dynamic':true },'.option-no .option-rect':{ 'height':30,'dynamic':true },'.option-no .option-text':{ 'text':'No','dynamic':true,'refY':15 }}},{ 'type':'qad.Question','optionHeight':30,'questionHeight':45,'paddingBottom':30,'minWidth':150,'ports':{ 'groups':{ 'in':{ 'position':'top','attrs':{ 'circle':{ 'magnet':'passive','stroke':'white','fill':'#feb663','r':14 },'text':{ 'pointerEvents':'none','fontSize':12,'fill':'white' }},'label':{ 'position':{ 'name':'left','args':{ 'x':5 }}}},'out':{ 'position':'right','attrs':{ 'circle':{ 'magnet':true,'stroke':'none','fill':'#31d0c6','r':14 }}}},'items':[{ 'group':'in','attrs':{ 'text':{ 'text':'in' }},'id':'17d84052-8cce-4357-89dc-92514c3a5cfe' },{ 'group':'out','id':'yes','args':{ 'y':60 }},{ 'group':'out','id':'no','args':{ 'y':90 }}] },'position':{ 'x':238,'y':429 },'size':{ 'width':155.625,'height':135 },'angle':0,'question':'Will you get screwed?','inPorts':[{ 'id':'in','label':'In' }],'options':[{ 'id':'yes','text':'Yes' },{ 'id':'no','text':'No' }],'id':'f473d963-30fb-4dd3-b51d-b3bd187391fc','z':3,'attrs':{ '.question-text':{ 'text':'Will you get screwed?' },'.options':{ 'transform':'translate(0, 45)' },'.option-yes':{ 'transform':'translate(0, 0)','dynamic':true },'.option-yes .option-rect':{ 'height':30,'dynamic':true },'.option-yes .option-text':{ 'text':'Yes','dynamic':true,'refY':15 },'.option-no':{ 'transform':'translate(0, 30)','dynamic':true },'.option-no .option-rect':{ 'height':30,'dynamic':true },'.option-no .option-text':{ 'text':'No','dynamic':true,'refY':15 }}},{ 'type':'qad.Answer','padding':50,'position':{ 'x':464,'y':65 },'size':{ 'width':223.796875,'height':66.8 },'angle':0,'answer':'Don\'t mess about with it.','id':'6d15cdcb-9981-4620-b023-b30d8f4f19d9','z':4,'attrs':{ 'label':{ 'text':'Don\'t mess about with it.' }}},{ 'type':'qad.Answer','padding':50,'position':{ 'x':343,'y':203 },'size':{ 'width':125.59375,'height':66.8 },'angle':0,'answer':'Run away!','id':'ef4e38b0-592b-415d-937f-75c74b969ad2','z':5,'attrs':{ 'label':{ 'text':'Run away!' }}},{ 'type':'qad.Answer','padding':50,'position':{ 'x':553,'y':400 },'size':{ 'width':117.296875,'height':66.8 },'angle':0,'answer':'Poor boy.','id':'61b31adc-2640-4790-a46a-bcc736dba3b6','z':6,'attrs':{ 'label':{ 'text':'Poor boy.' }}},{ 'type':'qad.Answer','padding':50,'position':{ 'x':553,'y':524 },'size':{ 'width':146.953125,'height':66.8 },'angle':0,'answer':'Put it in a bin.','id':'dc726ad6-0dbc-4185-986d-82204a4bc77a','z':7,'attrs':{ 'label':{ 'text':'Put it in a bin.' }}},{ 'type':'link','source':{ 'id':'41dd3458-88ec-4c64-a90c-1e2852dd2af5','magnet':'circle','port':'yes' },'target':{ 'id':'6d15cdcb-9981-4620-b023-b30d8f4f19d9' },'id':'ccf980a7-30b1-4095-abd5-1c965049cf2f','z':8,'attrs':{ '.marker-target':{ 'd':'M 10 0 L 0 5 L 10 10 z','fill':'#6a6c8a','stroke':'#6a6c8a' },'.connection':{ 'stroke':'#6a6c8a','strokeWidth':2 }}},{ 'type':'link','source':{ 'id':'41dd3458-88ec-4c64-a90c-1e2852dd2af5','magnet':'circle','port':'no' },'target':{ 'id':'22a1f5ae-c415-4927-bccc-403699971d88','magnet':'circle','port':'3da4004a-938e-4b8d-aac7-94f93eded50a' },'id':'b25db08c-72c7-4e49-b16a-e20182997f72','z':9,'attrs':{ '.marker-target':{ 'd':'M 10 0 L 0 5 L 10 10 z','fill':'#6a6c8a','stroke':'#6a6c8a' },'.connection':{ 'stroke':'#6a6c8a','strokeWidth':2 }}},{ 'type':'link','source':{ 'id':'22a1f5ae-c415-4927-bccc-403699971d88','magnet':'circle','port':'yes' },'target':{ 'id':'ef4e38b0-592b-415d-937f-75c74b969ad2' },'id':'774f37a6-7af0-4d9a-88d9-b8f784d945b9','z':10,'attrs':{ '.marker-target':{ 'd':'M 10 0 L 0 5 L 10 10 z','fill':'#6a6c8a','stroke':'#6a6c8a' },'.connection':{ 'stroke':'#6a6c8a','strokeWidth':2 }}},{ 'type':'link','source':{ 'id':'22a1f5ae-c415-4927-bccc-403699971d88','magnet':'circle','port':'no' },'target':{ 'id':'f473d963-30fb-4dd3-b51d-b3bd187391fc','magnet':'circle','port':'17d84052-8cce-4357-89dc-92514c3a5cfe' },'id':'f9f09b39-66d9-4ff9-9de7-c3b7df5eed13','z':11,'attrs':{ '.marker-target':{ 'd':'M 10 0 L 0 5 L 10 10 z','fill':'#6a6c8a','stroke':'#6a6c8a' },'.connection':{ 'stroke':'#6a6c8a','strokeWidth':2 }}},{ 'type':'link','source':{ 'id':'f473d963-30fb-4dd3-b51d-b3bd187391fc','magnet':'circle','port':'yes' },'target':{ 'id':'61b31adc-2640-4790-a46a-bcc736dba3b6' },'id':'4ff32e0f-9ed9-4461-97a3-745b05ec4447','z':12,'attrs':{ '.marker-target':{ 'd':'M 10 0 L 0 5 L 10 10 z','fill':'#6a6c8a','stroke':'#6a6c8a' },'.connection':{ 'stroke':'#6a6c8a','strokeWidth':2 }}},{ 'type':'link','source':{ 'id':'f473d963-30fb-4dd3-b51d-b3bd187391fc','magnet':'circle','port':'no' },'target':{ 'id':'dc726ad6-0dbc-4185-986d-82204a4bc77a' },'id':'bb7a8254-675c-4366-8f64-8150d0afaa97','z':13,'attrs':{ '.marker-target':{ 'd':'M 10 0 L 0 5 L 10 10 z','fill':'#6a6c8a','stroke':'#6a6c8a' },'.connection':{ 'stroke':'#6a6c8a','strokeWidth':2 }}}] });
    },
