...
(function() {
    ...
    new joint.dia.Paper({ el: $('#paper-ams-rain'), width: 800, height: 400, gridSize: 1, model: graph });
    ...
    var t = new joint.ui.Tooltip({
        ...
        content: function(elBar) {
            ...
            var precipitation = _.find(chart.get('series')[0].data, { x: x });
            var avgRainDays = _.find(chart.get('series')[1].data, { x: x });
