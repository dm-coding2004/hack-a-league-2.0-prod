...
export class NodeView extends dia.ElementView {
    ...
    openHelp(type, target) {
        return __awaiter(this, void 0, void 0, function* () {
            const helpHtml = yield (yield fetch(`assets/help/${type}.html`)).text();
...
export class Node extends dia.Element {
    ...
    defaults() {
        ...
        return Object.assign(Object.assign({}, super.defaults), { type: 'processor.Node', name: 'Node', inputSettings: [], outputSettings: [], properties: {}, outputs: [], group: 'basic', size: {
