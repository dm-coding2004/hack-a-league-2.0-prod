...
import { Dependency, Task } from './kanban/models';
...
export const init = () => {
    ...
    let cmdBuffer: dia.CommandManager.JSON;
    ...
    paper.unfreeze({
        viewport: (view) => {
            return kanban.showDependencyTool ? true : view.model.isElement();
        }
    });
    ...
    toolbar.on('dependencies:change', (enabled: boolean) => {
