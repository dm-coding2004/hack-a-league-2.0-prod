...
import { enableVirtualRendering } from 'src/rappid/features/virtual-rendering';
import { toolbarConfig } from 'src/rappid/config/toolbar.config';
import { BACKGROUND_COLOR, SECONDARY_BACKGROUND_COLOR, GRID_SIZE, PADDING_L, PADDING_S } from 'src/theme';
import './shapes/index';
