...
<div className='bg-gradient-to-r from-orange-300 via-red-500 to-yellow-500 h-[100vh] w-full pt-16 items-center justify-center flex '>
      ...
      >
        <SwiperSlide className='text-center text-lg  flex justify-center items-center  ' ><div className='flex text-white font-semibold text-[30px] items-center justify-center mt-[238px]'><h1>SLide 1</h1></div></SwiperSlide>
        <SwiperSlide className='flex justify-center items-center  ' ><div className='flex text-white font-semibold items-center justify-center mt-[238px] text-[30px]'>Slide 2</div></SwiperSlide>
